...
$from=$_POST['fromdate'];
$to=$_POST['todate'];
$purpose=$_POST['attend']."\ton".$_POST['topic']."\tat".$_POST['place'];
$ad=date("Y-m-d");
...
<p>
Sir,<br>
Kindly grant me Permission to attend the <select name="attend"><option value="Seminar">Seminar</option><option value="Conference">Conference</option><option value="Workshop">Workshop</option><option value="Examination">Examination</option><option value="SpotValuation">Spot Valuation</option></select> related to A.U. on "<input type="text" name="topic" placeholder="Enter topic here" required>" held at <input type="text" name="place" placeholder="Enter place here" required> from  <input type="date" name="fromdate" required>  to  <input type="date" name="todate" required>.  During my absence,my classwork will be taken up as detailed below:
</p>
...
<p>I will submit the certificate of attendance and copy of the brief report on the event on my return from O.D.</p>
