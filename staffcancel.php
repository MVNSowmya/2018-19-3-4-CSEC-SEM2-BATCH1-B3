...
while ($row=mysqli_fetch_all($h1,MYSQLI_BOTH)) {
  ...
  header("Location: staffviewcancelleaves.php");
...
<p>
Sir,<br>
I wish to cancel my <select name="leavetype"><option value="CasualLeave">CasualLeave</option><option value="EarnedLeave">EarnedLeave</option><option value="SickLeave">SickLeave</option><option value="NonVacationLeave">NonVacationLeave</option></select> day(s) from <input type="date" name="fromdate"> to <input type="date" name="todate"> because of the following reason: &nbsp;<input type="text" name="reason" required>.<br>
Thank You.
</p>
